...
WRITE the plan and return — NEVER block on a supervisor. Surface any blocker, decision, or ambiguity in the plan's `## Risks` (add a "Decisions needed" subsection if it helps) and return normally.

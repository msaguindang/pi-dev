...
## Instructions
1. Create `agents/data-analyst.md`. Add YAML frontmatter configuring it to use a high-reasoning model (`anthropic/claude-sonnet-4-6`). Its role is to parse logs, structure data, and analyze metrics. Include standard Caveman rules.
...
3. Copy `~/.agents/roles/controller.md` to `agents/system-architect.md` and prepend YAML frontmatter configuring it for `anthropic/claude-sonnet-4-6`.
